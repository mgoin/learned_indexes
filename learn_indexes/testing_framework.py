...
from models import Learned_FC, Learned_Res, Learned_Bits, Learned_AllBits, BTree, Hybrid, Hybrid_Original
...
def main(argv):
    ...
    if args.model is None:
        ...
        model = Learned_Bits()
    elif args.model in ('learned_allbits'):
        print("Testing with Learned AllBits model")
        model = Learned_AllBits()
